...
import { GraduationCap, PartyPopper, Calendar, MapPin, Clock } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
        <button className="group relative border border-foreground px-6 py-3 font-sans text-[10px] tracking-[0.3em] text-foreground uppercase transition-colors hover:bg-foreground hover:text-primary-foreground active:scale-[0.98]">
          <span>Agendar</span>
        </button>
        <button className="group relative border border-foreground px-6 py-3 font-sans text-[10px] tracking-[0.3em] text-foreground uppercase transition-colors hover:bg-foreground hover:text-primary-foreground active:scale-[0.98]">
  ...
  return (
    <section ref={ref} className="px-6 py-24 md:py-32">
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-6 md:flex-row md:gap-0">
        <EventBlock
          icon={<GraduationCap className="h-8 w-8 text-gold" strokeWidth={1} />}
          title="Ceremonia"
          date="18 de Diciembre, 2026"
          time="18:00 hs"
          location="Salon Imperial"
          delay={0}
        />
        <EventBlock
          icon={<PartyPopper className="h-8 w-8 text-gold" strokeWidth={1} />}
          title="Fiesta"
          date="18 de Diciembre, 2026"
          time="21:00 hs"
